* `src/`
    ...
    * `fst/`
        * `morphology/`
            * `stems/`
                * [rootStems.lexc](src-fst-morphology-stems-rootStems.lexc.html) ([src](https://github.com/giellalt/lang-epo/blob/main/src/fst/morphology/stems/rootStems.lexc))
        * `phonetics/`
        ...
        * `transcriptions/`
            ...
            * [transcriptor-symbols2text.lexc](src-fst-transcriptions-transcriptor-symbols2text.lexc.html) ([src](https://github.com/giellalt/lang-epo/blob/main/src/fst/transcriptions/transcriptor-symbols2text.lexc))
* `tools/`
    * `grammarcheckers/`
