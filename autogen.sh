...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_epo to login script."
...
# the current dir:
if   test x${GTLANG_epo} = x ; then
	echo "WARNING: The variable \${GTLANG_epo} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_epo} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_epo} has the value:"
	echo "  ${GTLANG_epo}"
